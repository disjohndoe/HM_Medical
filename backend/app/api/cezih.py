...
# DIAGNOSTIC (kept) — dump the live document-chain topology (id/status/OID/relatesTo/
# encounter) for a patient straight from CEZIH. Read-only, admin-only. Invaluable for
# verifying storno/amend end-states (e.g. old=eie/new=current/no-superseded). Keep.

...
// Returns the CEZIH doc type codes (011/012/013) that the clinic's djelatnost
// permits. Used by send-nalaz / record type pickers to hide ineligible options.
...
// ISO 3166-1 → Croatian country name. Our DB stores drzavljanstvo mostly as
// alpha-2 (e.g. "DE"), but CEZIH's FHIR address.country is alpha-3 ("DEU").
// The map carries BOTH so either code round-trips. Unmapped codes fall back
// to the raw code at the call site.
export const COUNTRY_HR: Record<string, string> = {
  // Croatia
  HR: "Hrvatska", HRV: "Hrvatska",
  // EU + neighbours
  AT: "Austrija", AUT: "Austrija",
  BA: "Bosna i Hercegovina", BIH: "Bosna i Hercegovina",
  BE: "Belgija", BEL: "Belgija",
  BG: "Bugarska", BGR: "Bugarska",
  CZ: "Češka", CZE: "Češka",
  DK: "Danska", DNK: "Danska",
  DE: "Njemačka", DEU: "Njemačka",
  ES: "Španjolska", ESP: "Španjolska",
  EE: "Estonija", EST: "Estonija",
  FI: "Finska", FIN: "Finska",
  FR: "Francuska", FRA: "Francuska",
  GB: "Ujedinjeno Kraljevstvo", GBR: "Ujedinjeno Kraljevstvo",
  GR: "Grčka", GRC: "Grčka",
  HU: "Mađarska", HUN: "Mađarska",
  IE: "Irska", IRL: "Irska",
  IT: "Italija", ITA: "Italija",
  XK: "Kosovo", KOS: "Kosovo",
  LU: "Luksemburg", LUX: "Luksemburg",
  LV: "Latvija", LVA: "Latvija",
  LT: "Litva", LTU: "Litva",
  MK: "Sjeverna Makedonija", MKD: "Sjeverna Makedonija",
  MT: "Malta", MLT: "Malta",
  ME: "Crna Gora", MNE: "Crna Gora",
  NL: "Nizozemska", NLD: "Nizozemska",
  NO: "Norveška", NOR: "Norveška",
  PL: "Poljska", POL: "Poljska",
  PT: "Portugal", PRT: "Portugal",
  RO: "Rumunjska", ROU: "Rumunjska",
  RS: "Srbija", SRB: "Srbija",
  SK: "Slovačka", SVK: "Slovačka",
  SI: "Slovenija", SVN: "Slovenija",
  SE: "Švedska", SWE: "Švedska",
  CH: "Švicarska", CHE: "Švicarska",
  TR: "Turska", TUR: "Turska",
  UA: "Ukrajina", UKR: "Ukrajina",
  // Common non-EU
  US: "Sjedinjene Američke Države", USA: "Sjedinjene Američke Države",
  CA: "Kanada", CAN: "Kanada",
  CN: "Kina", CHN: "Kina",
  RU: "Rusija", RUS: "Rusija",
  JP: "Japan", JPN: "Japan",
  AL: "Albanija", ALB: "Albanija",
};

...
| [2026-04-21-cezih-2.2-recurrence-not-supported.md](2026-04-21-cezih-2.2-recurrence-not-supported.md) | 2026-04-21 | active | H1 mirror (drop asserter, commit 6b29da4) FAILED for 2.2 — same ERR_HEALTH_ISSUE_2000. Next: H2 add `vezani-slucaj` extension for parent linkage. FE button still hidden. |

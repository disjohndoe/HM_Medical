...
| [2026-04-21-cezih-2.2-recurrence-not-supported.md](2026-04-21-cezih-2.2-recurrence-not-supported.md) | 2026-04-21 | active | 2.2 Ponavljajući signed bundle rejected by CEZIH with ERR_HEALTH_ISSUE_2000 / FHIR "not-supported". FE action reverted; backend local-DB parent lookup kept. Profile-level fix pending. |
| [2026-04-21-cezih-2.6-data-update-not-supported.md](2026-04-21-cezih-2.6-data-update-not-supported.md) | 2026-04-21 | active | 2.6 Data update signed bundle rejected with same ERR_HEALTH_ISSUE_2000 / "not-supported". Identifier verified correct. Likely profile-content issue (asserter/code/onsetDateTime sliced differently vs 2.4/2.9). TC17 cert blocker — UI button left in place. |
| [2026-04-21-handoff-2.2-and-2.6-profile-fix.md](2026-04-21-handoff-2.2-and-2.6-profile-fix.md) | 2026-04-21 | active | Self-contained handoff doc for debugging 2.2 + 2.6 in a fresh chat. Covers reproduction, hypotheses, experiment plan, Simplifier SD download, DB/logs queries. START HERE next session. |
